...
const groups = [
  ...
  },
  {
    ...
    items: [
      { to: "/facturacion-electronica", label: "Facturación Electrónica", icon: FileText, tid: "nav-fe" },
      { to: "/facturacion-pos-electronica", label: "POS Electrónica", icon: Receipt, tid: "nav-pos-electronica", badge: "Sim" },
      { to: "/remisiones", label: "Remisiones", icon: ClipboardList, tid: "nav-remisiones" },
      { to: "/nomina-electronica", label: "Nómina Electrónica", icon: FileSignature, tid: "nav-nomina", badge: "Sim" },
      { to: "/documento-soporte", label: "Doc. Soporte", icon: FileText, tid: "nav-doc-soporte", badge: "Sim" },
      { to: "/radian", label: "Radian", icon: ShieldCheck, tid: "nav-radian", badge: "Sim" },
      { to: "/notas", label: "Notas Crédito/Débito", icon: FileText, tid: "nav-notas" },
      { to: "/cuentas-cobro", label: "Cuentas de Cobro", icon: BadgeDollarSign, tid: "nav-cuentas" },
      { to: "/certificado-digital", label: "Certificado Digital", icon: Award, tid: "nav-certificado", badge: "Sim" },
    ],
  },
  {
    ...
    items: [
      ...
      { to: "/promociones", label: "Promociones/Ofertas", icon: Percent, tid: "nav-promociones" },
    ],
  },
  {
    ...
    items: [
      ...
      { to: "/comisiones", label: "Comisiones", icon: BadgeDollarSign, tid: "nav-comisiones" },
