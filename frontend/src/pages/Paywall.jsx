...
import { QrCode, ShieldCheck, MessageCircle, RefreshCw } from "lucide-react";
      ...
      <div className="w-full max-w-3xl">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">
            Paga por QR o transferencia, envía el comprobante y tu tienda queda activa en minutos.
          </p>
        </div>
              ...
              <CardContent className="p-6 text-center">
                ...
                {wa && (
                  <a href={wa} target="_blank" rel="noreferrer">
                    <Button className="mt-5 w-full bg-emerald-600 hover:bg-emerald-500 text-white">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="text-lg font-bold text-emerald-400" data-testid={`plan-${pl.id}`}>
                          ${new Intl.NumberFormat("es-CO").format(pl.price_cop)}
                        </div>
                        <div className="text-[10px] text-slate-500">COP/mes</div>
                      </div>
                    </div>
